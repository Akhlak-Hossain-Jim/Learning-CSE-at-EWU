...
class RanBigSmall {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This program is generating a random array with 100 elements and finding the highest and smallest value with index.");
        int[] arr = new int[100];
        ...
        System.out.println("A random array with 100 elements is successfully generated.\nFinding the highest and smallest value with index.");
        maximum(arr);
        minimum(arr);
    }
}